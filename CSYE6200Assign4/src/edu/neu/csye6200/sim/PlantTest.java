...
public class PlantTest {
	...
	// Store plant instances and flower plant instances
...
//			System.out.println(i);
		...
		// For PlantRoster Test
		plantlist = new ArrayList<Plant>();
	    plantlist.add(plt2);
	    plantlist.add(flrplt2);
	    plantlist.add(flrplt1);
	    plantlist.add(plt1);
	    plantlist.add(plt3);
	...
	// Test in run method
	public void run() {
		// Store plants and flowerplants
		plantMap.put(plt1.getSpecimenID(), plt1);
		plantMap.put(plt2.getSpecimenID(), plt2);
		plantMap.put(plt3.getSpecimenID(), plt3);
		plantMap.put(flrplt1.getSpecimenID(), flrplt1);
		plantMap.put(flrplt2.getSpecimenID(), flrplt2);
