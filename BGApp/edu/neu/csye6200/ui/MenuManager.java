...
//		fileMenu.addSeparator();
		...
		createMenuItem("core.window", "Undock window", KeyEvent.VK_D, ActionEvent.ALT_MASK + ActionEvent.SHIFT_MASK,
...
//		windowMenu.addSeparator();
	...
	/**
	 * Adds a named menu and set text values based on resource values
	 * @return the generated JMenu instance
	 */
